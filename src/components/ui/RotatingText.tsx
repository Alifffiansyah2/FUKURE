...
>(
  (
    ...
    const resolvedInitial: TargetAndTransition =
    ...
    const resolvedAnimate: TargetAndTransition =
      prefersReducedMotion
        ? {
            opacity: 1,
          }
    ...
    const resolvedExit: TargetAndTransition =
      prefersReducedMotion
        ? {
            opacity: 0,
          }
    ...
    const elementStartIndexes = useMemo(
      () => {
        let count = 0;
